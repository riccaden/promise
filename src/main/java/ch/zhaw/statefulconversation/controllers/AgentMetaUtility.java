...
public class AgentMetaUtility {
        ...
        private static String[][] buildBlockPrompts(String language, String nickname) {
                ...
                p[0][0] = langInstr
                                ...
                                + " Wenn eine Antwort zu kurz oder oberflächlich ist, stelle eine passende Nachfrage zur jeweiligen Frage (siehe Beispiele unten). Jede Frage kann übersprungen werden - akzeptiere das ohne Nachfragen."
                                + "\n\nFragen für diesen Block (mit möglichen Nachfragen bei kurzen Antworten):"
                                + "\n1. Wenn du morgen irgendwohin reisen könntest – wohin würde es gehen? → Nachfrage: 'Was zieht dich genau dorthin? Warst du schon mal da?'"
                                + "\n2. Hast du ein Haustier – oder hättest du gerne eins? → Nachfrage: 'Wie heisst es? Was macht es besonders?' oder 'Welches Tier wäre es und warum?'"
                                + "\n3. Was ist deine Lieblingsfarbe – und warum gerade die? → Nachfrage: 'Verbindest du eine Erinnerung oder ein Gefühl damit?'"
                                + "\n4. Kaffee oder Tee – und wie trinkst du ihn am liebsten? → Nachfrage: 'Gehört das zu einem bestimmten Ritual bei dir?'"
                                + "\n5. Meer oder Berge – wo zieht es dich eher hin? → Nachfrage: 'Was genau ist es, das dich daran anzieht?'"
                                + "\n6. Bist du eher Morgenperson oder Nachtmensch? → Nachfrage: 'Was machst du am liebsten in dieser Tageszeit?'"
                                + "\n7. Welche Jahreszeit magst du am liebsten – und was macht sie für dich besonders? → Nachfrage: 'Gibt es ein bestimmtes Erlebnis, das du damit verbindest?'"
                                + "\n8. Was ist dein absolutes Lieblingsessen - und was würdest du niemals essen? → Nachfrage: 'Wer hat dir das beigebracht oder wo hast du es zum ersten Mal gegessen?'"
                                + "\n9. Welches Lied, welcher Film oder welches Buch hat dich am meisten geprägt? → Nachfrage: 'Was genau daran hat dich so berührt?'"
                                + "\n10. Was ist eine Sache, die die meisten Menschen mögen, die du aber nicht ausstehen kannst? → Nachfrage: 'Gab es ein Erlebnis, das dazu geführt hat?'"
                                + "\n11. Wenn du einen ganzen freien Tag hättest ohne jede Verpflichtung - was wäre das Erste und das Letzte vor dem Einschlafen? → Nachfrage: 'Und mit wem würdest du diesen Tag am liebsten verbringen?'"
                                + keepShort + noWrapUp;
                p[0][1] = langInstr
